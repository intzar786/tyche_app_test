                              ...
                              <div class="dropdown-menu animated fadeIn" aria-labelledby="navbarDropdown">
                                 <div class="bg-gradient px-4 py-3">
                                    <div class="d-flex align-items-center justify-content-between">
                                       ...
                                       <a href="{{url('admin/logout')}}" class="text-white font-20 tooltip-wrapper" data-toggle="tooltip" data-placement="top" title="" data-original-title="Logout"> <i class="zmdi zmdi-power"></i></a>
                                    </div>
                                 </div>
                                 <div class="p-4">
                                    <a class="dropdown-item d-flex nav-link" href="{{url('admin/profile')}}/{{Auth::User()->id}}">
                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <li class="active"> <a href="{{url('admin/dashboard')}}">Tych</a> </li>
                                </ul>
                            </li>
                            <li>
                                <a class="has-arrow" href="javascript:void(0)" aria-expanded="false">
                            ...
                            <li>
                              ...
                              <li>
                                 <a  href="{{url('admin/upload-celebrities')}}" aria-expanded="false">
                                 <i class="ti-control-record"></i><span class="nav-title">Upload Celebrities</span></a>
