                                       ...
                                       <div class="tab-pane fade py-3 active show" id="payment" role="tabpanel" aria-labelledby="payment-tab">
                                          <div class="row">
                                             ...
                                             <div class="col-md-5">
                                                ...
                                                <form action="{{route('admin/paypal_key')}}" method="post" >
                                                     @csrf                                                   
                                             ...
                                             <div class="col-md-12">
                                                <div class="card">
                                                   <div class="card-body">
                                                         ...
                                                         <form action="{{route('admin/add_key')}}" method="post" >
                                                            @csrf 
                                       ...
                                       <div class="tab-pane fade py-3" id="captcha" role="tabpanel" aria-labelledby="captcha-tab">
                                          <div class="row">
                                             <div class="col-md-12">
                                                ...
                                                <form action="{{route('admin/add_repcha')}}" method="post" >
                                                     @csrf      
                                          ...
                                          <div class="row gx-2 gx-lg-3">
                                             <div class="col-md-12">
                                                <div class="card">
                                                   ...
                                                   @endif 
                                                     <form action="{{route('admin/add-wtsp')}}" method="post" >
                                                     @csrf  
                                                         <div class="row">
                                                            <div class="col-md-6 col-12">
                                                               <div class="form-group">
